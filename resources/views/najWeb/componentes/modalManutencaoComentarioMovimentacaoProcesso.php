<div class="modal fade" id="modal-manutencao-comentario-movimentacao-processo" role="dialog" aria-hidden="true">
    <div id="bloqueio-modal-manutencao-comentario-movimentacao-processo" class="loader loader-default"></div>
    <div class="modal-dialog" role="document" style="min-width: 70%; margin-top: 3%;">
        <div class="modal-content modal-content-shadow-naj" style="height: 60%;">
            ...
            <div class="card-body-naj page-content container-fluid mt-4">
                <form class="form-horizontal needs-validation" novalidate="" id="form-comentario-movimentacao-processo">
                    <div class="row">
                        <div class="col-12">
                ...
                <form class="form-horizontal needs-validation" novalidate="" id="form-atividade-movimentacao-processo">
            ...
            <div class="card-footer-naj">
                <div class="row">
                    ...
                    <div class="col-10">
                        <button type="button" id="gravarComentarioMovimentacaoProcesso" class="btn btnLightCustom" title="Gravar">
                            <i class="fas fa-save"></i>
                            Gravar
                        </button>
                        <button type="button" class="btn btnLightCustom" onclick="$('#modal-manutencao-comentario-movimentacao-processo').modal('hide');" title="Fechar">
                            <i class="fas fa-times"></i>
                            Fechar
                        </button>
                    </div>
