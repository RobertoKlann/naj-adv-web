        ...
        <div class="modal-content modal-content-shadow-naj">
            ...
            <div class="modal-body-naj">                
                <div class="form-group row">
                    <label for="input-nome-pesquisa" class="col-sm-4 control-label label-copiar-permissao">Copiando permissões de:</label>
                    <div class="col-sm-12 col-md-8 col-lg-8" style="margin-left: -5%;">
                        <div class="input-group">
                            <input type="text" id="input-nome-pesquisa" onkeypress="getUsuarios(this);" class="form-control">
                ...
                <div class="form-group row p-0 content-pai-select-ajax-copiar">
                    <div class="col-sm-12">
                        <div class="input-group content-select-ajax-copiar-permissao" id="content-select-ajax-naj">
                ...
                <div class="form-group row">
                    <label for="codigo_usuario" class="col-sm-4 control-label label-copiar-permissao">Para o usuário:</label>
                    <div class="col-md-8 col-lg-8 col-sm-12" style="margin-left: -5%;">
                        <div class="input-group">
                            <input type="text" name="codigo_usuario" class="form-control" disabled>
                            <span class="ml-1 mt-2">
