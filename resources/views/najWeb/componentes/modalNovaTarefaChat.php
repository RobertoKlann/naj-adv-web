<div class="modal fade" id="modal-nova-tarefa-chat" tabindex="-1" role="dialog" aria-hidden="true">
    <div id="bloqueio-nova-tarefa-chat" class="loader loader-default" data-half></div>
    <div class="modal-dialog modal-nova-tarefa-naj" role="document">
        <div class="modal-content modal-content-shadow-naj">
            ...
            <div class="modal-body-naj naj-scrollable" id="content-outside-tarefa" style="overflow-y: auto;">
                <form class="form-horizontal needs-validation" novalidate="" id="form-nova-tarefa-chat">
            ...
            <div class="card-footer-naj">
                ...
                <button type="button" id="nova-tarefa" class="btn btnLightCustom" title="Nova Tarefa" onclick="onClickNovaTarefa();">
