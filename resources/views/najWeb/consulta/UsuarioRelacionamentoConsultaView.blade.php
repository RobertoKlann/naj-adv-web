...
@section('title', 'Usuario - Relacionamentos')
...
<div class="email-app font-12" style="height: 100%">
    ...
    <div class="left-part content-pai-nav-left-naj">
        <div class="nav-menu-usuarios scrollable ps-container ps-theme-default" style="height:100%;">
            ...
            <ul class="nav-list-usuarios list-group nav-left-naj">
                ...
                <li class="list-group-item cursor-pointer option-selected"" onclick="onClickMenuUsuario('relacionamentos');">
    ...
    <div class="right-part ml-auto" id="content-table-dispositivos">
        ...
        <div id="datatable-relacionamentos" class="naj-datatable no-margin-datatable" style="height: 100%;"></div>
    </div>
</div>
...
@section('scripts')
    <script src="{{ env('APP_URL') }}js/tables/relacionamentoTable.js"></script>
    <script src="{{ env('APP_URL') }}js/usuario.js"></script>
    <script src="{{ env('APP_URL') }}js/usuarioRelacionamento.js"></script>
@endsection